...
$(document).ready(function() {
	...
	*/
	...
	$('.sectionWork').waypoint( function() {
		$('.sectionWork-item').each( function( index ) {
			var ths = $( this );
			setInterval( function() {
				ths.addClass('fadeInLeft');
			}, 200*index);
		});
	}, { offset : '80%' });

	$('.sectionService').waypoint( function() {
		$('.sectionService-article_medium').each( function( index ) {
			var ths = $( this );
			setInterval( function() {
				ths.addClass('fadeInUp');
				$('.sectionService-article_large').addClass('fadeInUp');
			}, 400*index);
		});
	}, { offset : '30%' });

	$('.sectionService').waypoint( function() {
		$('.sectionService-article_small').each( function( index ) {
			var ths = $( this );
			setInterval( function() {
				ths.addClass('fadeInUp');
			}, 200*index);
	...
	*/
	...
	$(".sf-menu").after("<div id='mobile-menu'>");
	$(".sf-menu").clone().appendTo("#mobile-menu");
	$("#mobile-menu").find("*").attr("style", "");
	$("#mobile-menu").find("ul").removeClass("sf-menu");
	...
	*/
	...
	$('.copyrightBox__siteUp').click(function(){
