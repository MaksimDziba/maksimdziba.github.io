...
$(function(){$("#responsiveTabs").responsiveTabs({startCollapsed:"accordion"}),$(".sectionWork-item").waypoint(function(){$(this.element).addClass("on")},{offset:"bottom-in-view"}),$(".sectionService-article").waypoint(function(){$(this.element).addClass("on")},{offset:"bottom-in-view"}),$(".mainSlider").slick({dots:!0,infinite:!0,speed:500,fade:!0,cssEase:"linear"}),jQuery(document).ready(function(){jQuery("ul.sf-menu").superfish({cssArrows:!1})}),$(".sf-menu").after("<div id='mobile-menu'>"),$(".sf-menu").clone().appendTo("#mobile-menu"),$("#mobile-menu").find("*").attr("style",""),$("#mobile-menu").find("ul").removeClass("sf-menu"),$(document).ready(function(){$("#mobile-menu").mmenu({slidingSubmenus:!1,extensions:["fx-menu-slide","pagedim-black"],counters:!0,iconPanels:!0,navbar:{title:"Кибер Телеком"},navbars:[{position:"bottom",content:["<a class='icon-facebook' href='#/'></a>","<a class='icon-vkontakte' href='#/'></a>","<a class='icon-twitter' href='#/'></a>"]}]});var e=$("#hamburger"),n=$("#mobile-menu").data("mmenu");e.on("click",function(){n.open()}),n.bind("open:finish",function(){setTimeout(function(){e.addClass("is-active")},100)}),n.bind("close:finish",function(){setTimeout(function(){e.removeClass("is-active")},100)})}),$(document).ready(function(){$(".popup-with-form").magnificPopup({type:"inline",preloader:!1,focus:"#name",callbacks:{beforeOpen:function(){$(window).width()<700?this.st.focus=!1:this.st.focus="#name"}}})}),$(".copyrightBox__siteUp").click(function(){$("html, body").animate({scrollTop:0},"slow")});try{$.browserSelector(),$("html").hasClass("chrome")&&$.smoothScroll()}catch(e){}$("#preloader").fadeOut()});